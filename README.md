...
===  (Funciona como separacion)

- Scripts para analizar el padron historico del SNI  

- Este repositorio sirve para reproducir los resultados en: URL (poner la liga) y DOI de tu paper  

Este pipeline toma como INPUT una archivo CSV con el numero de miembros que tuvieron un cambio de su distincion SNI, por año. Contacte a Araliz Lopez (aralizp@gmail.com) para saber el origen de los datos en detalles.  

Este pipeline entrega como OUTPUT dos tablas CSV que resumen la cantidad de DRs y DRAs que tienen cambios en el SNI, y dos graficos en PNG que muestran estos resultados (Hay que ser breves y descriptivos).

OUTPUTS (lo que se puede esperar de este script):
...
### Features
  **-v 0.0.1** (por ejemplo, si corrijo la version en python poner v 0.02 y decir corre en python)
...
#### paquetes R requeridos: las versiones estan en los paquetes instalados en R
...
3. Abre el script:  REvisar instrucciones de biofreelancer para leer codigo
```
02-grafica.R
```
...
---
### Referencias (poner si uso plink, etc.)
...
### Contacto
Si tienes preguntas, solicitudes, o bugs para reportar, abre un issue en github, o envia un email a <aralizp@gmail.com>  

### Dev Team (equipo de desarrollo)
Israel Aguilar-Ordonez <aralizp@gmail.com>   
